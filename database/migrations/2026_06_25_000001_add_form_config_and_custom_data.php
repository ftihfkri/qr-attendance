...
return new class extends Migration
{
    public function up()
    {
        ...
        // any custom columns the admin/staff added. (Guarded so re-runs never error.)
        if (!Schema::hasColumn('meetings', 'form_config')) {
        ...
        if (!Schema::hasColumn('attendance', 'custom_data')) {
